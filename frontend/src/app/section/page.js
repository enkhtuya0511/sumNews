    ...
    <div className="min-h-screen flex flex-col bg-[#f9f8f6]">
      ...
      <div className="w-[90vw] max-w-[1288px] flex items-start mx-auto flex flex-col text-[#0f151e] gap-[15px] mb-[50px]">
        <div className="w-full text-[15px] font-[400] flex justify-start mb-[20px]">
          ...
          <p className="font-bold first-letter:text-[14px] first-letter:uppercase ">
            {inputValue}
          </p>
        </div>
            ...
            {results?.map((article, idx) => (
              ...
              >
                ...
                <div className="flex flex-col w-full">
                  <a
                    href="#"
                    className="text-[14px] font-[700] text-[#666] mb-[5px]"
                  >
                    {article.section}
                  </a>
                  <h2 className="text-[#0f151e] font-[600] text-[24px] mb-[8px]">
                    {article.title}
                  </h2>
                  <p className="text-[16px] font-[400] text-[#0f151e] mb-[8px] line-clamp-2">
                    {article.summary}
                  </p>
